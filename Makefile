...
# translation
SOURCES = clwscdesktop.py ui_clwscdesktop.py clwscdw.py ui_clwscdw.py __init__.py clwscdesktopdialog.py
#TRANSLATIONS = i18n/clwscdesktop_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = clwscdesktop

PY_FILES = clwscdesktop.py clwscdesktopdialog.py clwscdw.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_clwscdesktop.py ui_clwscdw.py
